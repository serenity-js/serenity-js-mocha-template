...
of REST/HTTP APIs using [**Serenity/JS**](https://serenity-js.org) and [**Mocha**](https://mochajs.org/),
...
- [Serenity BDD living documentation](https://serenity-js.github.io/serenity-js-mocha-template/)

## Features

- Pre-configured **Serenity/JS** + **Mocha** + **TypeScript** setup
- Example test scenarios demonstrating REST/HTTP API testing
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://github.com/codespaces/new?ref=main&repo=serenity-js/serenity-js-mocha-template)
...
npx mocha spec/math-js_api.spec.ts
...
```
spec/
├── math-js_api.spec.ts                # Mocha test files
└── support/
    └── serenity.config.ts             # Serenity/JS configuration

src/
├── Actors.ts                          # Actor configuration with API abilities
...
**Key files:**
- `spec/*.spec.ts` - Mocha test scenarios
- `src/Actors.ts` - Actor configuration and abilities setup
- Tasks, questions, and interactions following the [Screenplay Pattern](https://serenity-js.org/handbook/design/screenplay-pattern/) can be added as needed
...
- [Tutorial: First API Scenario](https://serenity-js.org/handbook/web-testing/your-first-web-scenario/)
