...
of REST APIs using [**Serenity/JS**](https://serenity-js.org) and [**Mocha**](https://mochajs.org/),
...
- [Serenity/JS HTML Report](https://serenity-js.github.io/serenity-js-mocha-template/)

## Features

- Pre-configured **Serenity/JS** + **Mocha** + **TypeScript** setup
- Example API test scenarios demonstrating REST API testing with the Screenplay Pattern
...
npx cross-env BASE_API_URL=http://api.mathjs.org/v4/ mocha spec/math-js_api.spec.ts

# Run with grep pattern
npx cross-env BASE_API_URL=http://api.mathjs.org/v4/ mocha --grep "addition"
```
...
└── math-js_api.spec.ts                # Mocha test specifications

reports/serenity-js/                    # Generated Serenity/JS HTML reports
```

**Key files:**
- `spec/*.spec.ts` - Mocha test specifications
- `spec/support/serenity.config.ts` - Serenity/JS crew configuration
...
- Update `BASE_API_URL` in [`package.json`](package.json) to point to your API
- Add your test specs to `spec/` following the examples
